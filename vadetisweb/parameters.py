...
ANOMALY_TYPE_INSTANCE = 'Instance'
ANOMALY_TYPE_INDIVIDUAL = 'Individual'

ANOMALY_TYPES = (
    (ANOMALY_TYPE_INSTANCE, ANOMALY_TYPE_INSTANCE),
    (ANOMALY_TYPE_INDIVIDUAL, ANOMALY_TYPE_INDIVIDUAL)
)
